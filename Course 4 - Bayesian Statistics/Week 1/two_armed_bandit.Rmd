...
```{r E6}
data = data.frame(machine = c(1L, 2L, 2L, 1L, 1L, 2L, 1L, 2L, 2L, 2L, 2L, 1L, 1L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 1L, 1L, 2L, 1L, 2L, 1L, 1L, 1L, 2L, 1L, 1L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 2L, 1L, 2L, 2L, 2L, 2L, 1L, 2L, 1L), outcome = c("L", "W", "W", "W", "W", "W", "L", "L", "W", "W", "W", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "W", "L", "L", "L", "W", "L", "L", "W", "W", "L", "W", "W", "W", "W", "L", "L", "L", "W", "W", "L", "L", "L", "W", "L", "W", "L", "L", "L", "L"))

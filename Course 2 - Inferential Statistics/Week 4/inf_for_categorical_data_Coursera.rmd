...
us12athiest <- us12 %>% filter(us12$response == "atheist")
```
...
dim(us12)[1]
dim(us12athiest)[1]
prop <- (dim(us12athiest)[1]/dim(us12)[1])
prop
```
...
inference(y = response, data = atheism %>% filter(atheism$nationality == "India"), statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```

```{r}
inference(y = response, data = atheism %>% filter(atheism$nationality == "Netherlands"), statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
```{r spain-05-12}
athiest_sp <- atheism %>% filter(atheism$nationality == "Spain")
...
athiest_sp <- atheism %>% filter(atheism$nationality == "United States")
inference(y=response, x=year, data=athiest_sp, statistic="proportion", type="ht", method="theoretical", success="atheist", alternative = "twosided")
```
...
```{r type1}
inference(y=response, x=nationality, data=atheism, statistic="proportion", type="ht", method="theoretical", success="atheist", alternative = "greater", sig_level=.05)
